...
events.connect(events.INITIALIZED, function()
	local find_incremental = limoon.menu.menubar['Search/Find Incremental'][2]
	ignore = {ui.find.focus, find_incremental, limoon.menu.select_command, M.record}
end)
