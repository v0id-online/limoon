...
-- #### Variables
--
-- Variables are defined in the `limoon.snippets.variables` table. Li Moon expands
...
--	can add your own transform function to `limoon.snippets.transform_methods` if you
--	need to.
...
-- @function _G.limoon.editing.autocompleters.snippet
limoon.editing.autocompleters.snippet = function()
