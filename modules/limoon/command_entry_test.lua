...
test('ui.command_entry.run should consider limoon modules as globals', function()
...
test('ui.command_entry.run should tab-complete global limoon modules', function()
