...
local function m(path) return limoon.menu.menubar[path][2] end
...
keys.assign_platform_bindings{
	...
	[limoon.editing.paste_reindent] = {'ctrl+V', 'cmd+V', 'ctrl+meta+v'},
	...
	[limoon.editing.toggle_comment] = {'ctrl+/', 'cmd+/', {'ctrl+_', 'ctrl+@', 'meta+/'}},
	[limoon.editing.join_lines] = {'ctrl+j', 'cmd+j', 'meta+j'},
	...
	-- TODO: limoon.history.record
	-- TODO: limoon.history.clear
	-- Preferences.
	...
	[limoon.editing.goto_line] = {'ctrl+g', 'cmd+g', 'ctrl+g'},

	-- Tools.
	[ui.command_entry.run] = {'ctrl+e', 'cmd+e', 'ctrl+e'},
	[m('Tools/Select Command')] = {'ctrl+p', 'cmd+p', 'ctrl+p'},
	[limoon.run.run] = {'ctrl+r', 'cmd+r', 'ctrl+r'},
	[limoon.run.compile] = {'ctrl+C', 'cmd+C', 'ctrl+meta+c'},
	[limoon.run.build] = {'ctrl+B', 'cmd+B', 'ctrl+meta+b'},
	[limoon.run.test] = {'ctrl+T', 'cmd+T', 'ctrl+meta+t'},
	[limoon.run.run_project] = {'ctrl+R', 'cmd+R', 'ctrl+meta+r'},
	[limoon.run.stop] = {'ctrl+X', 'cmd+X', 'ctrl+meta+x'},
	[m('Tools/Next Error')] = {'ctrl+alt+e', 'ctrl+cmd+e', 'meta+e'},
	[m('Tools/Previous Error')] = {'ctrl+alt+E', 'ctrl+cmd+E', 'meta+E'},
	-- Bookmark.
	[limoon.bookmarks.toggle] = {'ctrl+k', 'cmd+k', 'ctrl+k'},
	-- TODO: limoon.bookmarks.clear
	...
	[limoon.bookmarks.goto_mark] = {'ctrl+K', 'cmd+K', 'ctrl+alt+k'},
	-- Macros.
	[limoon.macros.record] = {'alt+,', 'ctrl+,', 'meta+,'},
	[limoon.macros.play] = {'alt+.', 'ctrl+.', 'meta+.'},
	-- TODO: limoon.macros.save
	-- TODO: limoon.macros.load
	-- Quick Open.
	[m('Tools/Quick Open/Quickly Open User Home')] = {'ctrl+alt+u', 'ctrl+cmd+u', 'meta+u'},
	[m('Tools/Quick Open/Quickly Open Li Moon Home')] = {'ctrl+alt+h', 'ctrl+cmd+h', 'meta+h'},
	-- TODO: m('Tools/Quick Open/Quickly Open Current Directory')
	[io.quick_open] = {'ctrl+O', 'cmd+O', 'ctrl+meta+o'},
	-- Snippets.
	-- TODO: limoon.snippets.select
	[limoon.snippets.insert] = {'\t', '\t', '\t'},
	[limoon.snippets.previous] = {'shift+\t', 'shift+\t', 'shift+\t'},
	[limoon.snippets.cancel] = {'esc', 'esc', 'esc'},
	...
	-- TODO: limoon.editing.convert_indentation
	-- EOL Mode.
	...
	}, [macro_register(limoon.macros.save)] = {'ctrl+alt+R', 'ctrl+cmd+R', 'meta+R'},
	[macro_register(limoon.macros.play)] = {'ctrl+alt+r', 'ctrl+cmd+r', 'meta+r'},
